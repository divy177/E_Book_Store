...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-C+X+yLcrZVcXcIyZFm7kzVZK7jsF8Tv+x4EL2FgQ9t2CQUdHMPm4if5yWNSz6SLg" crossorigin="anonymous">
...
<body>
    ...
    <a href="horror_review.php" id="reviewButton">Leave Review</a>
    ...
    <div id="bookContainer">
        ...
        <div class="book" data-price="35" data-rating="5" data-name="Book 9">
            <img src="dracula.jpg" alt="Book 8">
            <p style="color: #dc143c">DRACULA</p>
            <p style="color: #dc143c">$35.00</p>
            <div class="stars">
                
            </div>
            <button onclick="addToCart('DRACULA', 35)"style="font-size: 20px;">Add to Cart</button>
            
        </div>

        <div class="book" data-price="32" data-rating="3" data-name="Book 10">
            <img src="frank.jpeg" alt="Book 8">
            <p style="color: #dc143c">FRANKENSTEIN</p>
            <p style="color: #dc143c">$32.00</p>
            <div class="stars">
                
            </div>
            <button onclick="addToCart('FRANKENSTEIN', 32)"style="font-size: 20px;">Add to Cart</button>
    </div><br><br>
    ...
    <h1 style="color: #dc143c; text-align: center !important; margin-left: 550px">Reviews</h1>
    <div class="clearfix"></div>
    <div id="reviewContainer" style="color: RED;">
        <?php
    ...
    books.forEach(book => {
        ...
        function addToCart(bookName, price) {
            ...
            plusButton.onclick = function() {
                ...
                cartItems.push({ bookName: bookName, price: price });
